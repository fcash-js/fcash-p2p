 ...
 * using the standard Fcash protocol. A Peer instance represents one connection
 * on the Fcash network. To create a new peer connection provide the host and port
