...
function builder(options) {
  ...
  if (!options.network) {
    options.network = fcashBase.Networks.defaultNetwork;
  }

  options.Block = options.Block || fcashBase.Block;
  options.BlockHeader = options.BlockHeader || fcashBase.BlockHeader;
  options.Transaction = options.Transaction || fcashBase.Transaction;
  options.MerkleBlock = options.MerkleBlock || fcashBase.MerkleBlock;
