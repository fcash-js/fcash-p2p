...
function builder(options) {
  ...
  if (!options.network) {
    options.network = fcore.Networks.defaultNetwork;
  }

  options.Block = options.Block || fcore.Block;
  options.BlockHeader = options.BlockHeader || fcore.BlockHeader;
  options.Transaction = options.Transaction || fcore.Transaction;
  options.MerkleBlock = options.MerkleBlock || fcore.MerkleBlock;
